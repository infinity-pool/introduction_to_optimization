# 2018016244 추현욱
# Problem 1-3_func1 _ diminishing stepsize (a_k = 1/(k + 1))
...
for k in range(0, MAX_ITER_NUM - 1):    # Get x_(k+1) from x_k
    ...
    x_datas[k + 1] = x_datas[k] - step_size * funcs.grad_f1(x_datas[k]) # Calculate x_(k+1) using 'gradient descent algorithm' with diminishing stepsize 1/(k + 1)
...
plt.title("Gradient Descent Algorithm(Problem 1-3, f1, diminishing stepsize)") # title
