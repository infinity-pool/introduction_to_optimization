# 2018016244 추현욱
# Problem 1-3_func2 _ constant stepsize (a_k = 0.01)
...
for k in range(0, MAX_ITER_NUM - 1):    # Get x_(k+1) from x_k
    x_datas[k + 1] = x_datas[k] - STEP_SIZE * funcs.grad_f2(x_datas[k]) # Calculate x_(k+1) using 'gradient descent algorithm' with constant stepsize
...
plt.title("Gradient Descent Algorithm(Problem 1-3, f2, const stepsize)") # title
